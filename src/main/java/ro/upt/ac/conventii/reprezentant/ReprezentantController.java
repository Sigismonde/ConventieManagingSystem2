...
@Controller
@RequestMapping("/reprezentant")
public class ReprezentantController {
    ...
    public String dashboard(Authentication authentication, Model model) {
        ...
        Reprezentant partner = reprezentantRepository.findByEmail(user.getEmail())
    ...
    public String aprobaConventie(@PathVariable("id") int id, 
        ...
        try {
            User user = (User) authentication.getPrincipal();
            Reprezentant reprezentant = reprezentantRepository.findByEmail(user.getEmail())
                    .orElseThrow(() -> new RuntimeException("Reprezentant not found"));
            
            // Verificăm dacă partenerul are semnătură încărcată
            if (reprezentant.getSemnatura() == null) {
                ...
                return "redirect:/reprezentant/conventii";
            }
            ...
            // Check if convention belongs to Reprezentant's company
            if (conventie.getCompanie().getId() != reprezentant.getCompanie().getId()) {
                redirectAttributes.addFlashAttribute("errorMessage", 
...
//            conventie.setStatus(ConventieStatus.APROBATA_PARTENER);
    ...
    public String viewConventie(@PathVariable("id") int id, 
        ...
        if (conventie == null || conventie.getCompanie().getId() != reprezentant.getCompanie().getId()) {
            return "redirect:/reprezentant/conventii";
        }
        ...
        return "reprezentant/conventie-view";
    }
...
// La final, adăugăm tabelul de semnături
 ...
 // În ReprezentantController
    private void addSignatureTable(Document document, Conventie conventie, Font font, Font boldFont, Authentication authentication) throws DocumentException {
        ...
        if (conventie.getStatus() == ConventieStatus.APROBATA_PARTENER || 
            ...
            if (reprezentant.getSemnatura() != null) {
                try {
                    Image signature = Image.getInstance(reprezentant.getSemnatura());
        ...
        // Notă: Chiar dacă e Reprezentant Controller, afișăm structura completă a documentului
 ...
 // În ReprezentantController.java - Înlocuiește metoda addSignaturesTableWord cu aceasta:
 ...
 // În ReprezentantController.java - Înlocuiește metoda addSignaturesTableWord cu aceasta:
            ...
            if (reprezentant.getSemnatura() != null) {
                try {
                    partnerRun.addPicture(
                        new ByteArrayInputStream(reprezentant.getSemnatura()),
    ...
    public String uploadSemnatura(@RequestParam("semnatura") MultipartFile file, 
        ...
        try {
            ...
            reprezentantRepository.save(partner);
